...
<div v-if="cards">
     ...
     <form @submit.prevent="updateEmployeeAll">
            ...
            <br>   <div class="containerr"><a @click="updateEmployeeScore"  class="button">Update score</a></div>
              <input v-model="signupScoreHistory" placeholder="edit score history" class="editing"> 
            <br>   <div class="containerr"><a @click="updateEmployeeScoreHistory"  class="button">Update score history</a></div>    
